...
///////////////////////////////////////////////////////////////////////////////////////
  ...
  const mult_point_by_const = (p,v) => ({ x: p.x * v, y: p.y * v });

  const spline = u => 
    sum_pts([
      mult_point_by_const(pk_n1, blendingFunctions[0](u)),
      mult_point_by_const(pk, blendingFunctions[1](u)),
      mult_point_by_const(pk_p1, blendingFunctions[2](u)),
      mult_point_by_const(pk_p2, blendingFunctions[3](u)),
    ]);
